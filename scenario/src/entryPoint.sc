...
theme: /
    state: Start
        ...
        a: Привет! В этом приложении можно играть со своими друзьями в шахматы. Для игры с пультом, нужно навести зеленый квадрат на фигуру, используя стрелки, подтвердить свой выбор нажатием Enter и таким же образом выбрать клетку, на которую будет осуществлен ход. А для того чтобы переместить фигуру голосовой командой, необходимо назвать пару координат, используя английское произношение букв. Например, B1 H7. 
        script:
